...
public:
	...
	TetGenClass(string inputFileName);
	...
	//by yu
	//RawMesh* SubdivideMesh;
	//bool Subdivide_midpoint(void);
	RawMesh parametricHex;
	RawMesh parametricTet;
	RawMesh realDomainTet;
	...
	bool HexMeshParametricDomain(const char *outputName, int octree_level_yu);
