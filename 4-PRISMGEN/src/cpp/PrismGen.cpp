...
const double PrismGenClass::WEIGHT_LENGTH_EWCVT = 1.0f; 

PrismGenClass::PrismGenClass(void)
{

}

bool PrismGenClass::ReadKTri(const char * filename)
{
	FILE *input;
	int i, j, elementType;
	int v[8];
	...
	/*	cout << "here" << endl;
		for (int loopi = 0; loopi < vertexNumber; loopi++)
		{
			...
			{
				cout << vertex[loopi][loopj] << ", ";
			}
			cout << endl;
		}

		cout << "here" << endl;
		for (int loopi = 0; loopi < elementNumber; loopi++)
		{
			for (int loopj = 0; loopj < 3; loopj++)
			{
				cout << element[loopi][loopj] << ", ";
			}
			cout << endl;
		}
...
PrismGenClass::PrismGenClass(string inputFileName)
{
	...
	tempName = inputName + "_test_tri.vtk";
...
bool PrismGenClass::ReadKHex(const char * filename)
{
	FILE *input;
	int i, j, elementType;
	int v[8];
...
bool PrismGenClass::Initialization()
{
...
bool PrismGenClass::InitializeSkeletonPoints()
{
...
bool PrismGenClass::RecursiveLocalCoordinateSystem(int start_vertex)
{
...
bool PrismGenClass::CalculateLocalCoordinateSystem(double vz[3], double vxpre[3], double vx[3], double vy[3])
{
...
bool PrismGenClass::CalculateRotationMatrix(SkeletonPoint &sp)
{
...
bool PrismGenClass::OutputLocalCoordinateSystem()
{
...
bool PrismGenClass::InitializeElement()
{
...
bool PrismGenClass::AssignPartToElement()
{
...
bool PrismGenClass::AssignClusterToElement()
{
...
double PrismGenClass::GetPhysicalDist(int index, const CVTElement &currentElement)
{
...
bool PrismGenClass::GetDirectNeighboringElementByElement(int elementID)
{
...
bool PrismGenClass::GetNeighboringElementInRings(int ringNumber)
{
...
bool PrismGenClass::InitializeSegments()
{
...
bool PrismGenClass::InitializeGeneratorsByInput()
{
...
double PrismGenClass::GetNormalDist(const Centroid &currentGenerator, const CVTElement & currentElement)
{
...
double PrismGenClass::NormalDist(double veca[], double vecb[])
{
...
bool PrismGenClass::NormalizeGeneratorNormal(Centroid &currentGenerator)
{
...
bool PrismGenClass::IsCounted(CVTElement &currentElement, int indexClusterNeiElement, int &position)
{
...
bool PrismGenClass::OutputPatchesVTK(const char *outputName)
{
...
bool PrismGenClass::OutputPatchesVTKPara(const char *outputName)
{
...
bool PrismGenClass::OutputPatchesVTKBifurcation(const char *outputName)
{
...
bool PrismGenClass::EdgeWeightedCVT()
{
...
bool PrismGenClass::DataTransfer(CVTElement &currentElement, int newIndex)
{
...
int PrismGenClass::GetShortestEWDist(CVTElement &currentElement)
{
...
double PrismGenClass::GetEWDist(const Centroid &currentGenerator, const CVTElement & currentElement)
{
...
bool PrismGenClass::PostProcessing()
{
...
bool PrismGenClass::IsBoundaryElement(CVTElement &currentElement)
{
...
bool PrismGenClass::EnforceLabelConnectivity()
{
...
bool PrismGenClass::CheckLabelConnectivity()
{
...
bool PrismGenClass::EnforceBoundaryConnectivity()
{
...
bool PrismGenClass::CheckBoundaryConnectivity()
{
...
bool PrismGenClass::InitializePolycube()
{
...
bool PrismGenClass::SmoothBoundaryCurve()
{
...
bool PrismGenClass::CurveFittingBoundaryCurve()
{
...
void PrismGenClass::SplineKnots(vector<int> &u, int n, int t)
{
...
void PrismGenClass::SplineCurve(const vector<XYZ> &inp, int n, const vector<int> &knots, int t, vector<XYZ> &outp, const vector<double> &ratio)
{
...
void PrismGenClass::SplineCurve(const vector<XYZ> &inp, int n, const vector<int> &knots, int t, vector<XYZ> &outp, int res)
{
...
void PrismGenClass::SplinePoint(const vector<int> &u, int n, int t, double v, const vector<XYZ> &control, XYZ &output)
{
...
double PrismGenClass::SplineBlend(int k, int t, const vector<int> &u, double v)
{
...
bool PrismGenClass::SearchCornerandBoundary()
{
...
bool PrismGenClass::IsCornerPoint(int vertexID)
{
...
int PrismGenClass::FindOneCornerPoint(Polycube &currentPolycubePatch)
{
...
bool PrismGenClass::IsBoundaryPoint(int vertexID)
{
...
bool PrismGenClass::IsBoundaryEdge(int vertexIDone, int vertexIDtwo)
{
...
int PrismGenClass::SearchCCWVertex(int vertexID, int elementID)
{
...
bool PrismGenClass::ModifyWrongBoundaryElements()
{
...
bool PrismGenClass::EdgeFlipTwoElements(int vertexID, int elementID)
{
...
//bool PrismGenClass::Subdivide_midpoint()
//{
//
//
//	SubdivideMesh = NULL;
...
bool PrismGenClass::ParametricMapping()
{
	...
	{
		polycubePara->Read(mapping_file.c_str());
	}
	else
	{
...
bool PrismGenClass::ParametricMappingCornerByInput()
{
...
bool PrismGenClass::ParametricMappingEdge()
{
...
bool PrismGenClass::ParametricMappingEdgeGeneral()
{
...
bool PrismGenClass::ParametricMappingInterior()
{
...
bool PrismGenClass::IsInteriorPoint(int vertexID)
{
...
bool PrismGenClass::InteriorMappingOnePatch(Polycube &currentPolycubePatch)
{
		...
		if(fabs(1.0/sqrt(2.0)-theta)>EPSILON)
		...
		else
         {
           ...
           //polycubePara->vertex[InteriorList[j]][(iConst+1)%3] = polycubePara->vertex[oneCorner][(iConst+1)%3];
			...
			//polycubePara->vertex[InteriorList[j]][(iConst) % 3] = polycubePara->vertex[oneCorner][(iConst) % 3] + (vertex[InteriorList[j]][(iConst) % 3] - vertex[oneCorner][(iConst) % 3]) / fabs(vertex[oneCorner][(iConst) % 3] - vertex[secCorner][(iConst) % 3])*fabs(polycubePara->vertex[oneCorner][(iConst) % 3] - polycubePara->vertex[secCorner][(iConst) % 3]);
			//polycubePara->vertex[InteriorList[j]][(iConst) % 3] = 0.0;
			//polycubePara->vertex[InteriorList[j]][(iConst) % 3] = 0.0;
...
bool PrismGenClass::FlipCheckEachPatch(Polycube &currentPolycubePatch)
{
...
bool PrismGenClass::SignedTriAreaElement(int elementID, int indexCluster)
{
...
bool PrismGenClass::MappingOnePatchWeighted(Polycube &currentPolycubePatch)
{
...
double PrismGenClass::TriAreaElement(int elementID)
{
...
bool PrismGenClass::MappingOnePatchPostProcessing(Polycube &currentPolycubePatch)
{
...
bool PrismGenClass::HexMeshParametricDomain(const char *outputName, int octree_level_yu)
{
	...
	if (READ_IN_PARAHEX_TORUS == 1)
	{
		...
		{
			int Prism_vertexNumber= sizeof(PRSIM_RAW_2_VERTEX) / sizeof(PRSIM_RAW_2_VERTEX[0]);
			int Prism_elementNumber= sizeof(PRSIM_RAW_2_ELEMENT) / sizeof(PRSIM_RAW_2_ELEMENT[0]);

			cout << Prism_vertexNumber <<" "<< Prism_elementNumber << endl;
			tempParametricHex.CreateNewMesh(tempParametricHex.HEXAHEDRON, Prism_vertexNumber, Prism_elementNumber);

			for (int loopi = 0; loopi < Prism_vertexNumber; loopi++)
			{
				for (int loopj = 0; loopj < 3; loopj++)
				{
					tempParametricHex.vertex[loopi][loopj] = PRSIM_RAW_2_VERTEX[loopi][loopj];
				}
				
				//tempParametricHex.vertexSign[loopi] = 1;

			}
			for (int loopi = 0; loopi < Prism_elementNumber; loopi++)
			{
				for (int loopj = 0; loopj < 8; loopj++)
				{
					tempParametricHex.element[loopi][loopj] = PRSIM_RAW_2_ELEMENT[loopi][loopj];
				}
		...
		{
			int Prism_vertexNumber = sizeof(PRSIM_RAW_3_VERTEX) / sizeof(PRSIM_RAW_3_VERTEX[0]);
			int Prism_elementNumber = sizeof(PRSIM_RAW_3_ELEMENT) / sizeof(PRSIM_RAW_3_ELEMENT[0]);
			...
			for (int loopi = 0; loopi < Prism_vertexNumber; loopi++)
			{
				for (int loopj = 0; loopj < 3; loopj++)
				{
					tempParametricHex.vertex[loopi][loopj] = PRSIM_RAW_3_VERTEX[loopi][loopj];
				}
			...
			for (int loopi = 0; loopi < Prism_elementNumber; loopi++)
			{
				for (int loopj = 0; loopj < 8; loopj++)
				{
					tempParametricHex.element[loopi][loopj] = PRSIM_RAW_3_ELEMENT[loopi][loopj]-1;
				}
				//tempParametricHex.elementSign[loopi] = 0;
			}
		}
		...
		{
			int Prism_vertexNumber = sizeof(PRSIM_RAW_4_VERTEX) / sizeof(PRSIM_RAW_4_VERTEX[0]);
			int Prism_elementNumber = sizeof(PRSIM_RAW_4_ELEMENT) / sizeof(PRSIM_RAW_4_ELEMENT[0]);
			...
			for (int loopi = 0; loopi < Prism_vertexNumber; loopi++)
			{
				for (int loopj = 0; loopj < 3; loopj++)
				{
					tempParametricHex.vertex[loopi][loopj] = PRSIM_RAW_4_VERTEX[loopi][loopj];
				}
			...
			for (int loopi = 0; loopi < Prism_elementNumber; loopi++)
			{
				for (int loopj = 0; loopj < 8; loopj++)
				{
					tempParametricHex.element[loopi][loopj] = PRSIM_RAW_4_ELEMENT[loopi][loopj] - 1;
				}
				//tempParametricHex.elementSign[loopi] = 0;
			}
		}
		...
		{
			int Prism_vertexNumber = sizeof(PRSIM_RAW_1_VERTEX) / sizeof(PRSIM_RAW_1_VERTEX[0]);
			int Prism_elementNumber = sizeof(PRSIM_RAW_1_ELEMENT) / sizeof(PRSIM_RAW_1_ELEMENT[0]);
			cout << endl;
			cout << Prism_vertexNumber << " " << Prism_elementNumber << endl;
			tempParametricHex.CreateNewMesh(tempParametricHex.HEXAHEDRON, Prism_vertexNumber, Prism_elementNumber);
			...
			for (int loopi = 0; loopi < Prism_vertexNumber; loopi++)
			{
				for (int loopj = 0; loopj < 3; loopj++)
				{
					tempParametricHex.vertex[loopi][loopj] = PRSIM_RAW_1_VERTEX[loopi][loopj];
				}
			...
			for (int loopi = 0; loopi < Prism_elementNumber; loopi++)
			{
				for (int loopj = 0; loopj < 8; loopj++)
				{
					tempParametricHex.element[loopi][loopj] = PRSIM_RAW_1_ELEMENT[loopi][loopj];
				}
				//tempParametricHex.elementSign[loopi] = 0;
			}
		}
		...
		if (octree_level_yu == 0)
		{
			cout << "octree_level 0 is polycube" << endl;
		}
		...
		parametricHex.ClearOldMesh();
		parametricHex.CreateNewMesh(parametricHex.HEXAHEDRON, tempParametricHex.vertexNumber, tempParametricHex.elementNumber);

		for (int loopi = 0; loopi < tempParametricHex.vertexNumber; loopi++)
		{
			for (int loopj = 0; loopj < 3; loopj++)
			{
				parametricHex.vertex[loopi][loopj] = tempParametricHex.vertex[loopi][loopj];
			}

			//parametricHex.vertexSign[loopi] = 1;

		}
		for (int loopi = 0; loopi < tempParametricHex.elementNumber; loopi++)
		{
			for (int loopj = 0; loopj < 8; loopj++)
			{
				parametricHex.element[loopi][loopj] = tempParametricHex.element[loopi][loopj];
			}
			//tempParametricHex.elementSign[loopi] = 0;
		}
		...
		//parametricHex.Write(tempName.c_str());

		tempName = inputName + "_paraHex_hex.vtk";
		parametricHex.Write(tempName.c_str());
		//parametricHex.Smooth(100);
		//getchar();
		/*string tempString;
...
bool PrismGenClass::HexMeshRealDomain(const char *outputName)
{

	realDomainHex.ClearOldMesh();
	realDomainHex.CreateNewMesh(realDomainHex.HEXAHEDRON, parametricHex.vertexNumber, parametricHex.elementNumber);
	...
	for (int loopi = 0; loopi < parametricHex.elementNumber; loopi++)
	{
		for (int loopj = 0; loopj < 8; loopj++)
		{
			realDomainHex.element[loopi][loopj] = parametricHex.element[loopi][loopj];
		}
		//parametricHex.elementSign[loopi] = 0;
	}
	...
	outputFileName = outputFileName +"_prism.k";
	...
	{
		output << i + 1 << "," << i + 1 << "," << realDomainHex.element[i][0] + 1 << "," << realDomainHex.element[i][1] + 1 << "," << realDomainHex.element[i][2] + 1 << "," << realDomainHex.element[i][3] + 1
			<< "," << realDomainHex.element[i][4] + 1 << "," << realDomainHex.element[i][5] + 1 << "," << realDomainHex.element[i][6] + 1 << "," << realDomainHex.element[i][7] + 1
			<< "\n";
	}

	output << "*NODE" << "\n";
	for (int i = 0; i < realDomainHex.vertexNumber; i++)
	{
		output << i + 1 << "," << realDomainHex.vertex[i][0] << "," << realDomainHex.vertex[i][1] << "," << realDomainHex.vertex[i][2] << "\n";
	}
...
bool PrismGenClass::HexMeshProjectionBoundary()
{
...
bool PrismGenClass::FindPropagationBoundElements(int vertexID)
{
...
bool PrismGenClass::Projection(double paraPosition[3], double *realPosition)
{
	...
	for (i = 0; i < NUM_POLYCUBE_PATCH; i++)
	{
		...
		//cout << "which patch "<< i << endl;
		//getchar();
		bool counted = false;

		for (j = 0; j < polycubePatch[i].numCorner; j++)
		{
			//cout << "polycubePatch[i].numCorner " << polycubePatch[i].numCorner << endl;
			p = 0;
			...
			//cout << "indexStart indexEnd" << indexStart <<" "<< indexEnd << endl;
			for (k = 0; k < 3; k++)
			{
			...
			//if (READ_IN_MAPPING == 1)
			//{
			//	//by yu   may be wrong in mapping need future test  solve not bijective problem
			//	if (q == 0)
			//	{
			//		if (fabs(polycubePara->vertex[indexEnd][2] - polycubePara->vertex[indexStart][2]) > EPSILON)
			//		{
			//			p = 0;
			//		}
			//		if (fabs(polycubePara->vertex[indexEnd][1] - polycubePara->vertex[indexStart][1]) > EPSILON)
			//		{
			//			p = 0;
			//		}
			//	}
			//	else if (q == 1)
			//	{
			//		if (fabs(polycubePara->vertex[indexEnd][q - 1] - polycubePara->vertex[indexStart][q - 1]) > EPSILON)
			//		{
			//			p = 0;
			//		}
			//		if (fabs(polycubePara->vertex[indexEnd][q + 1] - polycubePara->vertex[indexStart][q + 1]) > EPSILON)
			...
			//			p = 0;
			//		}
			//		if (fabs(polycubePara->vertex[indexEnd][0] - polycubePara->vertex[indexStart][0]) > EPSILON)
			//		{
			//			p = 0;
			//		}
			//	}
...
bool PrismGenClass::Propagation(int vertexID)
{
...
bool PrismGenClass::HexMeshProjectionInterior()
{
...
bool PrismGenClass::HexMeshOctreeSubdivision(const char *outputName)
{
...
double		PrismGenClass::TriArea(double v0[3], double v1[3], double v2[3])
{
	Vector3d n;
	Vector3d a(v1[0]-v0[0], v1[1]-v0[1], v1[2]-v0[2]);
	Vector3d b(v2[0]-v0[0], v2[1]-v0[1], v2[2]-v0[2]);
...
double		PrismGenClass::QuadArea(double v0[3], double v1[3], double v2[3], double v3[3], double *MassCenter)
{
	int i, j;
...
double		PrismGenClass::GetHexVolume(double p[8][3], double *MassCenter)
{	
	int i, j;
...
int PrismGenClass::GetLevel(int octree_id)
{
	int num = 0;
	int i = 0;
	while (1)
...
void PrismGenClass::OctreeidxToXYZ(int octree_id, int &x, int &y, int &z, int level)
{
	int idx;
...
int PrismGenClass::XYZToOctreeidx(int x, int y, int z, int level, int direction)
{
	int lres;
	lres = levelRes[level];
	int xx, yy, zz;
...
bool PrismGenClass::ReadKFileInitial(const char *inputName)
{
...
bool PrismGenClass::ReadKFileBeforePostProcessing(const char *inputName)
{
	int i, j, tempElementSign;
	string oneLine;
	...
	/*for (i = 0; i < elementNumber; i++)
	{
		cout << i<<": "<<elementArray[i].indexCluster<<endl;
	}*/
...
bool PrismGenClass::WriteKFileBeforePostProcessing(const char *outputName)
{
...
bool PrismGenClass::ReadKFileIndexPatch(const char *inputName)
{
	int i, j, tempElementSign;
	string oneLine;
...
bool PrismGenClass::WriteKFileIndexPatch(const char *outputName)
{
...
bool PrismGenClass::WriteKFileMapping(const char *outputName)
{
...
bool PrismGenClass::ReadKFileHexMeshPara(const char *inputName)
{
